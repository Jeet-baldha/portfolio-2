...
<div id="body" class="font-container px-4 sm:px-10 lg:px-20 bg-scroll">
  ...
  <span class="actual-text">&nbsp;Jeet&nbsp;</span>
  <span class="hover-text1" aria-hidden="true">&nbsp;Jeet&nbsp;</span>
</button>
<button data-text="Awesome" class="button2 dark:hidden block">
  <span class="actual-text">&nbsp;Jeet&nbsp;</span>
  <span class="hover-text2" aria-hidden="true">&nbsp;Jeet&nbsp;</span>
</button>
    ...
    <div id="hero" class="mt-20 mb-20 ">
      <div class=""><!-- commented text-center for having the text at left instead of center-->
        <h1 class="text-gray-950 dark:text-gray-100 text-3xl md:text-5xl font-bold mb-2 tracking-tight">Jeet Baldha</h1>
        <div id="typed-strings">
          <p class="text-gray-600 dark:text-gray-400 text-1xl md:text-2xl max-w-screen-md mx-auto font-normal tracking-tight mb-4">Student • Web Developer • Tech Enthusiast • Engineer</p>
        </div>
        ...
        <div class="max-w-screen-md mt-2 "><!-- commented mx-auto for having the text at left instead of center-->
          <p class="text-gray-800 dark:text-gray-200 text-xl md:text-3xl tracking-tight">I'm a passionate web developer from Rajkot, creating my unique digital world step by step. I'm currently pursuing an undergraduate course in engineering while developing websites and playing games in free time.</p>
        </div>
      </div>
      <div class=""><!-- commented text-center for having the text at left instead of center-->
        ...
        <div class="mt-8 flex flex-wrap gap-5  mb-16"><!-- commented justify-center for having the text at left instead of center-->
          <a href="https://github.com/jeet-baldha" aria-label="GitHub" target=_blank  class="dark:fill-white fill-black transition-transform hover:scale-150">
          ...
          <a href="https://www.linkedin.com/in/jeetbaldha/" aria-label="LinkedIn" target=_blank  class="dark:fill-white  transition-transform hover:scale-150 fill-black">
            <svg width="30" height="30" viewBox="0 0 15 15" xmlns="http://www.w3.org/2000/svg">
          ...
          <a href="https://www.instagram.com/jeet_baldha_/" aria-label="Instagram" target=_blank  class="dark:fill-white transition-transform  fill-black hover:scale-150">
          ...
          <a href="https://x.com/jeetbaldha26" aria-label="Twitter" target=_blank  class="dark:fill-white transition-transform  fill-black hover:scale-150">
            <svg width="30" height="30" viewBox="0 0 15 15" xmlns="http://www.w3.org/2000/svg">
      ...
      <div id="projects">
        ...
        <div id="cards" class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 px-4 sm:px-10 lg:px-20">
          <div id="block" class="mt-8 shadow-md dark:bg-zinc-900 bg-zinc-100 rounded-xl border-2 border-solid border-zinc-400 dark:border-zinc-700 hover:border-zinc-600 dark:hover:border-white  transform hover:scale-103 transition-transform">
            <img class="p-4 rounded-3xl" src="/codeLink.png" alt="codelink">
            <h1 class="dark:text-gray-100 text-4xl font-bold tracking-tight mx-5">CodeLink</h1>
            <p class="dark:text-gray-100 font-semibold text-md tracking-tight p-2 mx-5">A platform for real-time code sharing and live collaboration with video calling and multiple language support.</p>
            ...
            <!-- <a href="https://recipe-finder-pbl.netlify.app/" class="bg-gray-900 dark:bg-gray-100 items-center hover:scale-110 transition-transform transform text-white dark:text-black flex gap-2 p-3 rounded-md font-medium">Website
              ...
              <a href="https://github.com/Jeet-baldha/codeLink" class="bg-gray-900  items-center hover:scale-110 transition-transform transform dark:bg-gray-100 text-white dark:text-black flex gap-2 p-3 rounded-md font-medium">Github
          ...
          <div id="block" class="mt-8 shadow-md dark:bg-zinc-900 bg-zinc-100 rounded-xl border-2 border-solid border-zinc-400 dark:border-zinc-700 hover:border-zinc-600 dark:hover:border-white transform hover:scale-103 transition-transform">
            <img class="p-4 rounded-3xl" src="/t-hub.png" alt="T-hub store">
            <h1 class="dark:text-gray-100 text-4xl font-bold tracking-tight mx-5">T-hub Store</h1>
            <p class="dark:text-gray-100 font-semibold text-md tracking-tight p-2 mx-5">An e-commerce store for selling T-shirts, featuring a dynamic user interface and secure payment processing.</p>
            <div class="flex mt-4 mx-5 mb-5">
              <a href="https://github.com/Jeet-baldha/T-Hub" class="bg-gray-900 dark:bg-gray-100 items-center  text-white hover:scale-110 transition-transform transform dark:text-black flex gap-2 p-3 rounded-md font-medium">Github
                <svg class="fill-white dark:fill-black" width="22" height="22" viewBox="0 0 15 15" xmlns="http://www.w3.org/2000/svg">
                  <path d="M7.49933 0.25C3.49635 0.25 0.25 3.49593 0.25 7.50024C0.25 10.703 2.32715 13.4206 5.2081 14.3797C5.57084 14.446 5.70302 14.2222 5.70302 14.0299C5.70302 13.8576 5.69679 13.4019 5.69323 12.797C3.67661 13.235 3.25112 11.825 3.25112 11.825C2.92132 10.9874 2.44599 10.7644 2.44599 10.7644C1.78773 10.3149 2.49584 10.3238 2.49584 10.3238C3.22353 10.375 3.60629 11.0711 3.60629 11.0711C4.25298 12.1788 5.30335 11.8588 5.71638 11.6732C5.78225 11.205 5.96962 10.8854 6.17658 10.7043C4.56675 10.5209 2.87415 9.89918 2.87415 7.12104C2.87415 6.32925 3.15677 5.68257 3.62053 5.17563C3.54576 4.99226 3.29697 4.25521 3.69174 3.25691C3.69174 3.25691 4.30015 3.06196 5.68522 3.99973C6.26337 3.83906 6.8838 3.75895 7.50022 3.75583C8.1162 3.75895 8.73619 3.83906 9.31523 3.99973C10.6994 3.06196 11.3069 3.25691 11.3069 3.25691C11.7026 4.25521 11.4538 4.99226 11.3795 5.17563C11.8441 5.68257 12.1245 6.32925 12.1245 7.12104C12.1245 9.9063 10.4292 10.5192 8.81452 10.6985C9.07444 10.9224 9.30633 11.3648 9.30633 12.0413C9.30633 13.0102 9.29742 13.7922 9.29742 14.0299C9.29742 14.2239 9.42828 14.4496 9.79591 14.3788C12.6746 13.4179 14.75 10.7025 14.75 7.50024C14.75 3.49593 11.5036 0.25 7.49933 0.25Z" fill-rule="evenodd" clip-rule="evenodd"></path>
                </svg>
              </a>
          ...
          <div id="block" class="mt-8 shadow-md dark:bg-zinc-900 bg-zinc-100 rounded-xl border-2 border-solid border-zinc-400 dark:border-zinc-700 hover:border-zinc-600 dark:hover:border-white transform hover:scale-103 transition-transform">
            <img class="p-4 rounded-3xl" src="/filmyHub.png" alt="Filmyhub">
            <h1 class="dark:text-gray-100 text-4xl font-bold tracking-tight mx-5">FilmyHub</h1>
            <p class="dark:text-gray-100 font-semibold text-md tracking-tight p-2 mx-5">A movie database site providing real-time movie information using the TMDB API, including ratings, cast, and trailers.</p>
            <div class="flex mt-4 mx-5 mb-5">
            <!-- <a href="https://www.npmjs.com/package/the-currency-converter" class="bg-gray-900 items-center  dark:bg-gray-100 hover:scale-110 transition-transform transform border-2  text-white dark:text-black flex gap-2 p-3 rounded-md font-medium">Website
              ...
              <a href="https://github.com/Jeet-baldha/FilmyHub" class="bg-gray-900  items-center hover:scale-110 transition-transform transform dark:bg-gray-100 text-white dark:text-black flex gap-2 p-3 rounded-md font-medium">Github
                <svg class="fill-white dark:fill-black" width="22" height="22" viewBox="0 0 15 15" xmlns="http://www.w3.org/2000/svg">
                  <path d="M7.49933 0.25C3.49635 0.25 0.25 3.49593 0.25 7.50024C0.25 10.703 2.32715 13.4206 5.2081 14.3797C5.57084 14.446 5.70302 14.2222 5.70302 14.0299C5.70302 13.8576 5.69679 13.4019 5.69323 12.797C3.67661 13.235 3.25112 11.825 3.25112 11.825C2.92132 10.9874 2.44599 10.7644 2.44599 10.7644C1.78773 10.3149 2.49584 10.3238 2.49584 10.3238C3.22353 10.375 3.60629 11.0711 3.60629 11.0711C4.25298 12.1788 5.30335 11.8588 5.71638 11.6732C5.78225 11.205 5.96962 10.8854 6.17658 10.7043C4.56675 10.5209 2.87415 9.89918 2.87415 7.12104C2.87415 6.32925 3.15677 5.68257 3.62053 5.17563C3.54576 4.99226 3.29697 4.25521 3.69174 3.25691C3.69174 3.25691 4.30015 3.06196 5.68522 3.99973C6.26337 3.83906 6.8838 3.75895 7.50022 3.75583C8.1162 3.75895 8.73619 3.83906 9.31523 3.99973C10.6994 3.06196 11.3069 3.25691 11.3069 3.25691C11.7026 4.25521 11.4538 4.99226 11.3795 5.17563C11.8441 5.68257 12.1245 6.32925 12.1245 7.12104C12.1245 9.9063 10.4292 10.5192 8.81452 10.6985C9.07444 10.9224 9.30633 11.3648 9.30633 12.0413C9.30633 13.0102 9.29742 13.7922 9.29742 14.0299C9.29742 14.2239 9.42828 14.4496 9.79591 14.3788C12.6746 13.4179 14.75 10.7025 14.75 7.50024C14.75 3.49593 11.5036 0.25 7.49933 0.25Z" fill-rule="evenodd" clip-rule="evenodd"></path>
                </svg>
              </a>
        ...
        <div class="grid grid-cols-1 xl:grid-cols-2 gap-6">
            ...
            <div id="block" class="mt-8 p-4 grid col-span-1 shadow-md w-full dark:bg-zinc-900 bg-zinc-100 rounded-xl border-2 border-solid border-zinc-400 dark:border-zinc-700 hover:border-zinc-600 dark:hover:border-white transform hover:scale-105 transition-transform">
                ...
                <div class="flex flex-wrap gap-3 px-2 sm:px-5 pt-3 sm:pt-6">
                    ...
                    <img class="w-8 h-8 sm:w-16 sm:h-16 mb-5" src="https://skillicons.dev/icons?i=jquery" alt="JQuery">
            ...
            <h1 class=" dark:text-gray-100 text-2xl m-3 sm:text-4xl font-bold tracking-tight mb-4">Database and Tools</h1>
                ...
                <div class="flex flex-wrap gap-3 px-2 sm:px-5 pt-3 sm:pt-6">
                    ...
                    <img class="w-8 h-8 sm:w-16 sm:h-16 mb-5" src="https://skillicons.dev/icons?i=redis" alt="Redis">
...
<div id="Contact" class="mt-20 mb-20 pt-8 ">
  ...
  <div id="block" class="flex justify-center items-center">
    ...
    <form
  action="https://formspree.io/f/manwzwrb"
  method="POST"
>
    ...
    <button class="cursor-pointer group relative flex gap-1.5 px-8 py-4 bg-black bg-opacity-80 text-[#f1f1f1] rounded-lg hover:bg-opacity-70 transition font-semibold shadow-md">
        ...
        </svg><a href="https://drive.google.com/file/d/12uX-qfqBU1tFRsmByLbTlkeFcfxEz2Lz/view?usp=drive_link" target=_blank>
        Resume</a>
        <div class="absolute opacity-0 -bottom-full rounded-md py-2 px-2 bg-black bg-opacity-70 left-1/2 -translate-x-1/2 group-hover:opacity-100 transition-opacity shadow-lg">
          <a href="https://drive.google.com/file/d/12uX-qfqBU1tFRsmByLbTlkeFcfxEz2Lz/view?usp=drive_link" target=_blank>Resume</a>
